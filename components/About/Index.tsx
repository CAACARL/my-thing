  ...
  return (
    <section id="about" className="py-16 md:py-24">
      <FadeIn>
        ...
        <p className="text-base text-black-700 leading-loose w-full md:max-w-2xl">
          Hi, I’m Carlo, an aspiring web developer with a strong interest in building practical and
